"""
Django settings for muddy_mud_dev_134640 project.
...
ROOT_URLCONF = 'muddy_mud_dev_134640.urls'
...
WSGI_APPLICATION = 'muddy_mud_dev_134640.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_mud_dev_134640 API",
    "DESCRIPTION": "API documentation for muddy_mud_dev_134640 App",
    "VERSION": "v1",
}
